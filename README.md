<center><h1>Yandex.Practicum projects</h1><center>
<a href="https://praktikum.yandex.ru/"><img width=100% src="https://kursvill.ru/upload/iblock/094/0949badcde1bc46c4f8bc64383eee5b1.jpg"></a><br><br>
<p align=center>

В данном репозитории расположены работы выполненные мной в период обучения на направлении Data Science в Яндекс.Практикуме. Ниже представленны визуализация моих вечеров, дней, а иногда и утрр в формате .ipynb за первые 9 месяцев 2022-го года.
Проекты расположены в хронологическом порядке, от первого проекта по базовому питону выполненного в феврале до финального проекта завершенного 24-го сенятбря.
...
***Используемые навыки:*** ResNet50, keras, Adam, Dense, GlobalAveragePooling2D, Sequential, ImageDataGenerator, tensorflow.
...
## 15. Исследование оттока клиентов телеком оператора "Ниединогоразрыва.ком"
*Проект по модулю "Финальный проект"*

***Используемые навыки:*** Matplotlib, plotly, Pandas, Scikit-learn, train_test_split, feature_importances_, RandomForestClassifier, LogisticRegression, LGBMClassifier, f1_score, roc_auc_score, f1_score, StandardScaler RandomizedSearchCV.
    
В нашем расположении есть персональные данные клиентов собранные командой оператора. Нам предстоит решить задачу бинарной классификации и дать прогноз уйдет клиент или нет, для того чтобы оператор мог заблаговременно предпринять какие-либо шаги по удержанию клиента(особые условия, скидки, промокоды и т.д).
