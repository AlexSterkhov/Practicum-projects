...
***Используемые навыки:*** Статистический анализ данных, Телеком, Data Analyst, Matplotlib, NumPy, Pandas, Python, SciPy, histogram, boxplot, статистический тест, критерий Стьюдента описательная статистика, проверка статистических гипотез.
